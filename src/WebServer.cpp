...
void WebServer::_prepareHeader(String &response, int code, const char *content_type, size_t contentLength)
{
  ...
  if (_corsEnabled)
  {
    sendHeader(String("Access-Control-Allow-Origin"), String("*"));
    sendHeader(String("Access-Control-Allow-Methods"), String("*"));
    sendHeader(String("Access-Control-Allow-Headers"), String("*"));
  }
...
void WebServer::send(int code, const char *content_type, const char *content)
{
  ...
  {
    Serial.println("String cast failed.  Use send_P for long arrays");
  }
...
void WebServer::_streamFileCore(const size_t fileSize, const String &fileName, const String &contentType, const int code)
{
  ...
  if (fileName.endsWith(String(mimeTable[gz].endsWith)) &&
      contentType != String(mimeTable[gz].mimeType) &&
...
void WebServer::_handleRequest()
{
  ...
  else
  {
    ...
    if (!handled)
    {
      Serial.println("request handler failed to handle request");
    }
  }
